...
export const documentApi = api.injectEndpoints({
  endpoints: (builder) => ({
    ...
    createDocument: builder.mutation<Document, { workspaceId: string; title: string; parentId?: string; content?: string }>({
    ...
    updateDocument: builder.mutation<Document, { workspaceId: string; id: string; title?: string; content?: string; changeSummary?: string }>({
